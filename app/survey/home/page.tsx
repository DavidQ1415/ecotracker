...
const questions = [
  "I turn off lights and electronics when they are not in use.",
  "My home uses energy-efficient appliances and lighting.",
  "I reduce heating or cooling when I leave the house.",
  "I try to use renewable energy sources (e.g., solar, wind) when possible.",
];
...
export default function HomeSurvey() {
  ...
  // Store responses locally under the 'homeCategory' key
  useEffect(() => {
    localStorage.setItem("homeCategory", JSON.stringify(answers));
  }, [answers]);
  ...
  return (
    <section className="flex flex-col items-center gap-6">
      <h2 className="text-2xl font-semibold text-[var(--accent)]">Home</h2>
